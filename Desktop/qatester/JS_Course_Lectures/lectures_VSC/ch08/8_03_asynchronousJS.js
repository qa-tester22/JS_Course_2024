...
Именно это и позволяют нам делать асинхронные функции. Остальная часть этого модуля объясняет, как они реализованы в JavaScript.
...
Обработчик событий (event handler) — это особый тип обратного вызова. 
